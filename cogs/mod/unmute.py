...
from main import client, footer, botversion, icon, c_em_b, c_em_e, c_em_s
...
class UnMute(commands.Cog):
    ...
    async def unmute(self, ctx, member: nextcord.Member, *, reason="Aucune raison n'a été renseignée"):
        ...
        embed = nextcord.Embed(title="<:coche:935279475539722241> Unmute",
                               description=f"{member.mention} a retrouvé la voix", color=c_em_b)
